 ...
 * @author Michael Rapp
 */
public abstract class AbstractStringNonPatriciaSortedTrieTest<TrieType extends SortedStringTrie<String>>
        extends AbstractNonPatriciaSortedTrieTest<String, TrieType> {
    ...
    public final void testSubTree1() {
        testPut7();
        SortedStringTrie<String> subTrie = trie.subTrie(convertToSequence("t"));
    ...
    public final void testSubTree2() {
        testPut7();
        SortedStringTrie<String> subTrie = trie.subTrie(convertToSequence("te"));
        assertFalse(subTrie.isEmpty());
