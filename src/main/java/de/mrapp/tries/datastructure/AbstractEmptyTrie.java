 ...
 * @since 1.0.0
 */
public abstract class AbstractEmptyTrie<SequenceType extends Sequence, ValueType> implements
        Trie<SequenceType, ValueType> {

    /**
     * The constant serial version UID.
     */
    private static final long serialVersionUID = -7165083158305602784L;
